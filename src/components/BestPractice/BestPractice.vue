...
import BestPracticeOptions from './BestPracticeOptions';
...
export default {
    ...
    data() {
        return {
            bestPracticeActive: 'control'
        }
    },
    methods: {
        setNewSlug(Slug) {
            this.bestPracticeActive = Slug
        }
    }
}
</script>
